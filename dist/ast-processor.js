...
var AstProcessor = /** @class */ (function () {
    ...
    AstProcessor.prototype.buildUiElements = function (uiElements) {
        ...
        for (var _i = 0, uiElements_1 = uiElements; _i < uiElements_1.length; _i++) {
            ...
            var element = { name: name_1, widget: widget, position: position, props: props };
    ...
    AstProcessor.prototype.getUiElementType = function (uiElement) {
        ...
        var entities = uiElement.items.find(function (item) { return item.property === TYPE_PROPERTY; }).nlpResult.entities;
        var elementType = entities.find(function (entity) { return entity.entity === UI_ELEMENT_TYPE; }).value;
        return elementType;
    };
    ...
    AstProcessor.prototype.extractArrayFromValue = function (value) {
        ...
        var values = match[0].replace(/(\[|\"|\])/g, '').split(',').map(function (value) { return (value.trim()); });
        return values;
    };
    AstProcessor.prototype.getUiElementProps = function (uiElement) {
        var TYPE_PROPERTY = 'type';
        var items = uiElement.items.filter(function (item) { return item.property !== TYPE_PROPERTY; });
        var props = {};
    ...
    AstProcessor.prototype.processAstFile = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.filterAstFile(filePath)];
                    case 1:
                        content = _a.sent();
                        docs = content.shift().docs;
                        docs = docs.filter(function (doc) { return doc.feature; });
                        features = docs.map(function (doc) { return _this.getFeatureFromDoc(doc); });
